...
-- Fix: Create missing base tables if V000 was skipped
-- =====================================================
-- Description: This migration ensures all base tables from V000
--              exist in the database. This is needed when V000
--              was skipped during Flyway baseline.
-- =====================================================
...
-- Create subject table (base version)
